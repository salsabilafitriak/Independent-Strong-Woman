...
#include "stack.h"  ///edit 1 
#include "time_travel.h"    ///edit 2
...
int main() {
    ...
    Folder* child = create_folder(folders[i]);
    ...
    while (1) {
        ...
        ///edit 10
            ...
            if (current_pos == virus_pos) {
                strcpy(log_msg, "⚠ VIRUS DETECTED IN CURRENT NODE");
            }
                }
                    ...
                    if (current_pos == virus_pos) {
                        strcpy(log_msg, "☠ VIRUS CORE DETECTED");
                    }

                    else if (current_pos == key_pos) {
                        strcpy(log_msg, "🔑 SECRET_KEY DETECTED");
                    }
                }
                    ...
                    if (current_pos == virus_pos) {
                        strcpy(log_msg, "🧠 QUIZ NODE DETECTED");
                    }
                }
        ///
        ...
        ///edit 5
        save_checkpoint(pHP, loc_display, root);
        ///
        ...
        if (strcmp(cmd, "time") == 0) {
            ...
            printf("Enter checkpoint version (0-4): ");
            scanf("%d", &version);

            time_travel(version, &pHP, loc_display, &root);

            strcpy(log_msg, "Timeline restored.");
        ...
        /// edit 11
                ...
                if (wave == 1) {
                    ...
                    else if (current_pos == virus_pos) {

                        printf("\n========================\n");
                        printf("GHOST_FILE.txt\n");
                        printf("------------------------\n");
                        printf("ENCRYPTED VIRUS CORE\n");
                        printf("========================\n");
